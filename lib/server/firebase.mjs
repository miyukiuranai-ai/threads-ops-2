...
function getApp() {
  ...
  // ローカル検証: Firestore エミュレータ（FIRESTORE_EMULATOR_HOST）なら鍵なしで初期化
  if (process.env.FIRESTORE_EMULATOR_HOST) {
    app = initializeApp({ projectId: env.FIREBASE_PROJECT_ID || 'demo-to2', storageBucket: env.FIREBASE_STORAGE_BUCKET || undefined });
    return app;
  }
